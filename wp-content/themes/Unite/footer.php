...
<footer id="colophon" class="site-footer" role="contentinfo">
	<div class="site-info">			
			Copyright ©&nbsp; <?php date('Y'); bloginfo('name');?><span class="plxiaoshi"> &nbsp; | &nbsp; Theme by <a title="主题设计者：懿古今" href="http://yigujin.wang/unite" target="_blank"><?php echo get_current_theme(); ?></a></span><span class="footer-tag">&nbsp; | &nbsp; Powered by <a href="http://wordpress.org/" title="优雅的个人发布平台" target="_blank" rel="nofollow">WordPress</a> &nbsp; | &nbsp;  <a href="http://www.miitbeian.gov.cn/" target="_blank" rel="nofollow"><?php echo stripslashes(get_option('ygj_icp')); ?></a></span>
		</div><!-- .site-info -->
</footer><!-- .site-footer -->
	</div>
</div>	
