...
?>
	...
	<div class="comment-author vcard">
		...
		<strong><span class="duzhe"><?php commentauthor(); ?></span><?php get_author_class($comment->comment_author_email,$comment->user_id); ?><?php if(user_can($comment->user_id, 1)){echo '<span class="dengji">【站长】</span>';}; ?></strong><span class="reply_t"><?php comment_reply_link(array_merge( $args, array('reply_text' => '&nbsp;@回复', 'add_below' =>$add_below, 'depth' => $depth, 'max_depth' => $args['max_depth']))); ?></span><br/>
