...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<header class="entry-header">
			<h2 class="entry-title"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>"><?php echo cut_str($post->post_title,60); ?></a></h2>		
		</header><!-- .entry-header -->
		...
		<div class="entry-content">
			...
			<div class="archive-content">			 				
				<?php if (has_excerpt()){ the_excerpt();} else { echo mb_strimwidth(strip_tags(apply_filters('the_content', $post->post_content)), 0, 268,"..."); } ?>
			</div>		
			<div class="clear"></div>
		</div><!-- .entry-content -->
